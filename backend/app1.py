...
class StreamingAnalyzer(QuadraticCSVAnalyzer):
    ...
    #             # Generate comprehensive report
    #             self.emit_stream('status', "📋 Generating comprehensive report...")
    #             result = self._generate_comprehensive_report_streaming(user_query, is_forecasting)
    #         else:
    #             # Focus on DataFrame results with fallback
    #             self.emit_stream('status', "📊 Focusing on DataFrame results...")
    #             result = self._generate_dataframe_analysis_streaming_with_fallback(user_query, data_request, is_forecasting)
    ...
    #         # Create error result and add to history
    #         error_result = {
    #             "error": error_msg,
    #             "traceback": traceback.format_exc(),
    #             "type": "error",
