  ...
  return (
    <section className={`py-24 ${themeClasses.bg} relative overflow-hidden`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Performance Report Mockup - Updated with conditional gradient background */}
          <motion.div
            initial={{ opacity: 0, x: -40 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
                    ...
                    {[...Array(12)].map((_, i) => (
                      <motion.div
                        ...
                        style={{ 
                          height: `${Math.random() * 80 + 20}%`,
                          background: isDark 
                            ? 'linear-gradient(180deg, #32C9F0 0%, #1D748A 100%)'
                            : 'linear-gradient(90deg, #04165D 0%, #000723 100%)'
                        }}
                        initial={{ height: 0 }}
                        whileInView={{ height: `${Math.random() * 80 + 20}%` }}
                        transition={{ duration: 1, delay: i * 0.1 }}
