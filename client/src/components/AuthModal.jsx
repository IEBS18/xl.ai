...
const AuthModal = ({ isOpen, mode, onClose, onSwitchMode }) => {
  ...
  // In AuthModal.jsx, replace the handleSubmit function with this fixed version:
...
}, [validateForm, formData, mode, login, register, resetForm, onClose])
                ...
                <div className="max-w-md mx-auto">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full pl-10 pr-4 py-3 border rounded-lg transition-all duration-200 ${errors.firstName ? themeStyles.inputError : `${themeStyles.input} ${themeStyles.inputFocus}`
                                }`}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={handleInputChange}
                              className={`w-full pl-10 pr-4 py-3 border rounded-lg transition-all duration-200 ${errors.lastName ? themeStyles.inputError : `${themeStyles.input} ${themeStyles.inputFocus}`
                                }`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full pl-10 pr-12 py-3 border rounded-lg transition-all duration-200 ${errors.password ? themeStyles.inputError : `${themeStyles.input} ${themeStyles.inputFocus}`
                            }`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full pl-10 pr-12 py-3 border rounded-lg transition-all duration-200 ${errors.confirmPassword ? themeStyles.inputError : `${themeStyles.input} ${themeStyles.inputFocus}`
                              }`}
                    ...
                    <motion.button
                      type="submit"
                      disabled={isLoading}
                      className={`w-full py-3 rounded-lg font-medium transition-all duration-200 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed ${isDark
