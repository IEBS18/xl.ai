          ...
          {isCollapsed ? (
            ...
            <motion.div className="p-3 space-y-2" variants={contentVariants} animate="expanded">
              {[
                ...
                //   active: false, // Dashboard doesn't need active state since it navigates away
                // },
              ].map((item, index) => (
                <motion.button
                  key={index}
              ...
              {activeView === "chat" ? (
                ...
                >
                  ...
                  <div className="px-4 pb-4">
                    <div className={`p-4 rounded-xl ${isDark ? "bg-white/5 border-white/10" : "bg-black/5 border-black/10"} border`}>
                      <div className="text-center">
                        <LayoutDashboard className={`w-12 h-12 ${isDark ? "text-white/40" : "text-black/40"} mx-auto mb-3`} />
                        <h3 className={`text-sm font-semibold ${isDark ? "text-white" : "text-black"} mb-2`}>
                          Dashboard Management
                        </h3>
                        <p className={`text-xs ${isDark ? "text-white/60" : "text-black/60"}`}>
                          Create and manage visualization dashboards. Add charts from your conversations to build comprehensive analytics views.
                        </p>
                      </div>
                    </div>
                  </div>
